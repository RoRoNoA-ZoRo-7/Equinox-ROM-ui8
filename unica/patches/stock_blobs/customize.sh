...
DELETE_FROM_WORK_DIR "system" "system/cameradata/camera-feature.xml" #dk what im doing 😭 
ADD_TO_WORK_DIR "$TARGET_FIRMWARE_PATH" "system" "system/cameradata/camera-feature.xml" 0 0 755 "u:object_r:system_file:s0"
